...
module.exports.createApplication = function(config, callback) {
    ...
    */
    ...
    if(config.database.mongo) {
        ...
        mongoose.connect(config.database.mongo.uri, { db: {safe: true} });
        ...
        model.mongodb = new mongodb.Db(dbName, new mongodb.Server(dbHost, dbPort, {}), {safe: true});
