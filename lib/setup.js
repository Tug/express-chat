...
module.exports.createApplication = function(config, callback) {
    ...
    app.cookieParser = app.express.cookieParser(app.session.secret);
    ...
    */
    ...
    // returns a url from the handler name
    ...
    require("./controllers.js").draw(expressApp, urlRoutes, app.controllers);
